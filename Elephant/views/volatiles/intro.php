  ...
  <div class="view" style="background-image: url('img/background.jpg'); background-repeat: no-repeat; background-size: cover;">
    ...
    <div  class="mask rgba-black-light d-flex justify-content-center align-items-center">
      ...
      <div class="text-center white-text mx-5 wow fadeIn">
        <h1 class="mb-4">
          <strong>Aprende desarrollo Web desde el Backend PHP</strong>
        </h1>

      

        <h4 class="mb-4 d-none d-md-block">
          <strong>Videos, screencasts y consejos para que aprendas desarrollo dinámico de forma práctica y amena.</strong>
        </h4>
